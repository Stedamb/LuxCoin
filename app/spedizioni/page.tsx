...
export default async function ShippingPage() {
  const shippingOptions =
    await client.fetch<ShippingOption[]>(shippingOptionsQuery);
    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/30 pb-20">
      <section className="pt-32 pb-12 container mx-auto px-4 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          La sicurezza del tuo investimento è la nostra priorità. Scegli il
          metodo di consegna più adatto alle tue esigenze.
        </p>
      </section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-card border border-white/5 rounded-2xl p-6 shadow-lg flex flex-col items-center justify-center text-center">
            ...
            <p className="text-muted-foreground text-sm mb-6">
              Contatta il nostro concierge per organizzare un trasporto
              personalizzato o per spedizioni in zone remote.
            </p>
            <Link
              href="/contatti"
