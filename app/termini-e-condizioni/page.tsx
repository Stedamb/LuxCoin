    ...
    <main className="min-h-screen bg-background text-foreground selection:bg-primary/30 pb-20">
      <section className="pt-32 pb-12 container mx-auto px-4 text-center">
        ...
        <p className="text-muted-foreground max-w-2xl mx-auto text-lg">
          Si prega di leggere attentamente i seguenti termini prima di
          ...
          {settings?.termsAndConditions ? (
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <p>
                  Benvenuti su LuxCoin. L'accesso e l'utilizzo di questo sito
                  web, così come l'acquisto di prodotti da LuxCoin, sono
                  regolati dai presenti Termini e Condizioni. Accedendo al sito,
                  l'utente accetta di essere vincolato da questi termini.
                </p>
              </div>

              <div className="space-y-4">
                <h2 className="text-2xl font-serif font-bold text-foreground">
                  2. Autenticità e Garanzie
                </h2>
                <p>
                  Tutti gli articoli venduti da LuxCoin sono garantiti autentici
                  senza limiti di tempo. Ogni moneta è accompagnata da un
                  certificato di autenticità fotografico e descrittivo.
                </p>
              </div>

              <p className="italic text-sm">
                Contenuto gestibile tramite il Pannello di Controllo (Sanity
                Studio).
              </p>
            </div>
          )}
