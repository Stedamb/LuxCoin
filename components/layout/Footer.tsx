    ...
    <footer className="bg-background py-16 border-t border-white/10 text-muted-foreground z-10 relative">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="space-y-4">
            ...
            <p className="text-sm leading-relaxed">
              La destinazione definitiva per i collezionisti di numismatica
              antica. Autenticità, storia e valore eterno.
            </p>
          </div>
          ...
          <div>
            <Newsletter />
            <h4 className="font-bold text-foreground mb-4 mt-4">Seguici</h4>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-sm">
          <p>
            &copy; {new Date().getFullYear()} LuxCoin - P.IVA{" "}
            {settings?.vatNumber || "04849590403"}
          </p>
          <p>
            Designed by{" "}
            <Link
              href="https://stedamb.it"
              target="_blank"
